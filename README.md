...
```Shell
conda create --name bootcamp python=3.12
...
creating websites online at https://jupyterbook.org/en/stable/intro.html.
...
contributors in the [contributors tab](https://github.com/BYUCamachoLab/photonics_bootcamp/graphs/contributors).
